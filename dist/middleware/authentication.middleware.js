...
var users_model_1 = __importDefault(require("../resources/users/users.model"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, users_model_1.default.findById(payload.id)
                            .select('-password')
                            .exec()];
                case 3:
                    user = _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    return [2 /*return*/, next(new http_exceptions_1.default(401, 'Unauthorised'))];
